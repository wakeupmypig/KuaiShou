...
angular.module('starter', ['ionic', 'ngCordova', 'starter.controllers', 'starter.directives', 'starter.services','starter.filters'])
  ...
  .run(function ($rootScope, $ionicPlatform, $state,  $location,$timeout,$ionicHistory,$cordovaToast,$cordovaKeyboard, $cordovaAppVersion,$ionicPopup,$http) {
    $ionicPlatform.ready(function () {
      ...
      function checkUpdate() {
        $http({
          ...
          $rootScope.serverAppPath = homeurl + '/App/down/download?type=1';
